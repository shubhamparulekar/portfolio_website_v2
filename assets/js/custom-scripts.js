...
|================
*/
$('.mh-company-tab').on('click', function() {
    // Remove active class from all tabs
    $('.mh-company-tab').removeClass('active');
    ...
    $('.mh-work-experience-item').removeClass('active');
    // Show the corresponding job detail
    $('.mh-work-experience-item[data-company-detail="' + company + '"]').addClass('active');
});